...
import { TechTypes } from "./TechTypes";
  ...
  export default new Map<string, string>([
    ...
    [TechTypes.JAVA_SCRIPT, javaScriptLogo],
    [TechTypes.MS_SQL, sqlServerLogo],
    [TechTypes.REACT, reactLogo],
    [TechTypes.REVIT, revitLogo],
    [TechTypes.TYPE_SCRIPT, typeScriptLogo],
    [TechTypes.WPF, wpfLogo],
    [TechTypes.XAMARIN, xamarinLogo],
]);